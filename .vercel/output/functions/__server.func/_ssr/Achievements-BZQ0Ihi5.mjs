...
import { c as hackathons, i as achievements, t as Reveal } from "./Reveal-rwHvY0UL.mjs";
import { c as Award, r as Trophy, t as Zap } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/Achievements-BZQ0Ihi5.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: achievements.map((a, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "h-5 w-5 text-accent shrink-0" }),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: hackathons.map((h, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
						delay: i * .06,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "group relative overflow-hidden rounded-2xl glass-strong p-6 hover:bg-white/5 transition-colors",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Zap, { className: "h-5 w-5 text-accent" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trophy, { className: "absolute -bottom-4 -right-4 h-24 w-24 text-white/[0.03] group-hover:text-accent/10 transition-colors" })
							]
						})
					}, h.name))
				})
